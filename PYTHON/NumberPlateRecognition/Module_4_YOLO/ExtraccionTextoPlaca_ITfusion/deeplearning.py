...
def object_detection(placa):
    # read image
    image = cv2.imread(placa)
...
#text_list = object_detection('.','placacol.jpg')
text_list = object_detection('placaamarilla.jpg')
#texto = "CKG:716"
texto = text_list[0]
#print('Texto inicial encontrado:'+texto)
patron = r"([a-zA-Z]{3}).*(\d{3})"
resultado = re.search(patron, texto)
if resultado:
   print("Número de placa adecuada encontrada:", resultado.group(1)+'-'+resultado.group(2))
   print('Numero de placa original leida por algoritmo:'+text_list[0])
else:
